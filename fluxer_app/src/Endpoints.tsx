...
export const Endpoints = {
	...
	CHANNEL_CALENDAR: (channelId: string) => `/channels/${channelId}/calendar`,
	CHANNEL_CALENDAR_EVENT_RSVP: (channelId: string, eventId: string) =>
		`/channels/${channelId}/calendar/events/${eventId}/rsvp`,
